...
way to ensure that the data the user understands, and inputs the correct data or data type.
1. In 1-2 sentences, define end to end testing.
A test that runs through all your code to test the front and back end
## Instructions
